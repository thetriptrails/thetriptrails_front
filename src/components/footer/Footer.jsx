  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `linear-gradient(to right, transparent, ${brandGold}, ${brandDark}, ${brandGold}, transparent)`,
        }}
      />
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-1 space-y-8">
            <div className="flex flex-col gap-6">
              ...
              <p className="text-gray-400 text-sm leading-relaxed max-w-sm">
                Your premium travel partner for exploring the incredible
                diversity of India. From the Himalayas to the backwaters, we
                create unforgettable journeys since 2009.
              </p>
            </div>
            ...
            <div className="flex gap-4">
              {[
                ...
                {
                  Icon: Instagram,
                  href: "https://www.instagram.com/triptrailsofficial?igsh=MWhobXc2Mm42NHc0YQ==",
                },
                { Icon: Twitter, href: "https://x.com/thetriptrails" },
                { Icon: Youtube, href: "#" },
              ].map((item, i) => {
                ...
                return (
                  ...
                  >
                    <IconComponent size={20} style={{ color: brandGold }} />
                  </a>
                );
              })}
            </div>
                ...
                <li key={link.label} className="group">
                  ...
                  >
                    {link.active ? (
                      ...
                      <ChevronRight
                        size={14}
                        className="opacity-0 -ml-4 group-hover:opacity-100 group-hover:ml-0 transition-all text-[#BFA13B]"
                      />
                    )}
                    {link.label}
                  </a>
            ...
            <ul className="space-y-4">
              {DESTINATIONS.map((link) => (
                <li key={link.label} className="group">
                  <a
                    href={link.href}
                    className="text-gray-400 hover:text-white flex items-center gap-1 text-[13px] font-medium transition-all"
                  >
                    <ChevronRight
                      size={14}
                      className="opacity-0 -ml-4 group-hover:opacity-100 group-hover:ml-0 transition-all text-[#BFA13B]"
            ...
            <ul className="space-y-6">
              <li className="flex items-start gap-4">
                ...
                <div className="flex flex-col gap-3">
                  <div>
                    <p className="text-white text-[12px] font-bold mb-0.5">
                      Uttarakhand Office:
                    </p>
                    <span className="text-gray-400 text-[13px] leading-relaxed">
                      Himmatpur Block, Near Sai Mandir, Jim Corbett, Ramnagar,
                      244715
                    </span>
                  </div>
                  <div>
                    ...
                    <span className="text-gray-400 text-[13px] leading-relaxed">
                      Mustil No - 45, Killa No 6/2, Begampur Khatola, Gurugram,
                      Haryana - 122001
                    </span>
                  </div>
                </div>
              ...
              <li className="flex items-center gap-4">
                ...
                />
                <a
                  href="mailto:info@thetriptrails.com"
                  className="text-gray-400 text-[13px] hover:text-white transition-colors truncate"
                >
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex gap-6 text-[10px] font-bold uppercase tracking-[0.2em] text-gray-500">
              <a
                href="/privacy-policy"
                className="hover:text-[#BFA13B] transition-colors"
              >
                Privacy Policy
              </a>
              <a
