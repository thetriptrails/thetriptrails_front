    ...
    const fetchPackages = async () => {
      try {
        ...
        const filtered = allData.filter(pkg => {
          ...
          return andamanStates.some(state => pkgState.includes(state));
        });

        console.log("Filtered Andaman Packages:", filtered);
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-8">
          <h2 className="text-3xl md:text-5xl font-serif font-bold text-gray-900 mt-3">
            Discover Your Perfect <span className="text-[#D4AF37]">Andaman Packages</span>
          </h2>
